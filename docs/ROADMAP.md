...
(`publish-cover`) — **v1.17.1's is done**: verified 2026-07-29 that both `docs/cover.html` and the
live `menubar-load-runner.pages.dev` serve the v1.17.1 badge, and that HEAD is tagged `v1.17.1` with a
clean tree.
